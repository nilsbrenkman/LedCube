...
static const uint8_t dogica_glyph_bitmap[] = {
...
static const font_glyph_dsc_t dogica_glyph_dsc[] = {
    ...
    {.w_px = 7, .glyph_index = 40},  /*Unicode: U+0025 (%)*/
    ...
    {.w_px = 6, .glyph_index = 232}, /*Unicode: U+003d (=)*/
    {.w_px = 3, .glyph_index = 240}, /*Unicode: U+003e (>)*/
    {.w_px = 5, .glyph_index = 248}, /*Unicode: U+003f (?)*/
    {.w_px = 7, .glyph_index = 256}, /*Unicode: U+0040 (@)*/
    ...
    {.w_px = 6, .glyph_index = 504}, /*Unicode: U+005f (_)*/
    ...
    {.w_px = 7, .glyph_index = 616}, /*Unicode: U+006d (m)*/
    ...
    {.w_px = 6, .glyph_index = 696}, /*Unicode: U+0077 (w)*/
    ...
    {.w_px = 6, .glyph_index = 752}, /*Unicode: U+007e (~)*/
    {.w_px = 3, .glyph_index = 760}, /*Unicode: U+007f ()*/
};
...
const font_t dogica = {
    ...
    .glyph_bitmap = dogica_glyph_bitmap, /*Bitmap of glyphs*/
    .glyph_dsc = dogica_glyph_dsc,       /*Description of glyphs*/
    .glyph_cnt = 96,                     /*Number of glyphs in the font*/
    // .unicode_list = NULL,	/*Every character in the font from
    // 'unicode_first' to 'unicode_last'*/ .get_bitmap =
    // lv_font_get_bitmap_continuous,	/*Function pointer to get glyph's
    // bitmap*/ .get_width = lv_font_get_width_continuous,	/*Function
    // pointer to get glyph's width*/ .bpp = 1,				/*Bit
    // per pixel*/ .monospace = 0,				/*Fix width (0:
    // if not used)*/ .next_page = NULL,		/*Pointer to a font
    // extension*/
};
